...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/1.png){:height="500" width="500"}  

## 问题现象   

业务同学反馈，某个服务的部分容器异常，一直在重启，看了一下重启容器中`JVM`监控，发现一直在进行`FullGC`。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/2.png){:height="500" width="500"}  

于是也同步分析了一下GC信息，就看到了下面的结果。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/3.png){:height="500" width="500"}  

看完就愣住了，老年代64KB是什么鬼。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/4.png){:height="500" width="500"}  

## 问题分析  

看到这里，首先想到的是看看启动时是不是配置的`JVM`参数不对。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/5.png){:height="500" width="500"}  

启动时配置了`xms`和`xmx`，都是1GB。  

但是结合前面的图就好像不对劲，GC日志分析的结果显示年轻代和老年大大小都对不上，于是实际登上容器`jmap`了一把。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/6.png){:height="500" width="500"}  

那么问题来了，`xmx`配置了1GB，老年代+年轻代的大小总和也确实是1GB，但是两者的大小比例并不是我们熟知的2:1（NewRatio），也就意味着肯定还有地方配置了年轻代或老年代大小相关的参数。  

于是顺手看一下进程启动的完整命令，就找到了问题点。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/7.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/8.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/9.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/10.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/11.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/12.png){:height="500" width="500"}  
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/13.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/14.png){:height="500" width="500"}  

综上来看，最终`init_gen0_size`、`min_gen0_size`、`max_gen0_size`最终都会设置为`max_heap_size - {gen_aligenment}`。  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/15.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/16.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/17.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/18.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/19.png){:height="500" width="500"}  
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/20.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/21.png){:height="500" width="500"}  
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/22.png){:height="500" width="500"}  

在设置时，会通过一个特殊的宏定义来进行属性值设置，并在一些场合判断该值是否为某些特殊场景的设置值，实际定义共有这些类型：  

![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/23.png){:height="500" width="500"}  
...
![](https://github.com/Taaang/blog/blob/master/assets/images/post_imgs/jvm_heap/24.png){:height="500" width="500"}  
